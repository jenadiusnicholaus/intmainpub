    ...
    darkMode: function () {
        ...
        if (e.isVariableDefined(dark)) {
          ...
          var changeThemeToDark = () => {
            ...
            if(dir == 'rtl') {
                style.setAttribute('href', '/static/assets/css/style-dark-rtl.css');
            } else {
                style.setAttribute('href', '/static/assets/css/style-dark.css');
            }
          ...
          var changeThemeToLight = () => {
            ...
            if(dir == 'rtl') {
                style.setAttribute('href', '/static/assets/css/style-rtl.css');
            } else {
